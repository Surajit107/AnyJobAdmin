                            ...
                            <div className="card">
                                ...
                                <div className="card-body p-4">
                                    ...
                                    <div className="text-center w-75 m-auto">
                                        <h4 className="text-dark-50 text-center mt-0">See You Again !</h4>
                                        <p className="text-muted mb-4">You are now successfully sign out.</p>
                                    </div>

                                    <div className="logout-icon m-auto">
                                        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                            viewBox="0 0 161.2 161.2" enableBackground="new 0 0 161.2 161.2" xmlSpace="preserve">
                                            <path className="path" fill="none" stroke="#0acf97" strokeMiterlimit="10" d="M425.9,52.1L425.9,52.1c-2.2-2.6-6-2.6-8.3-0.1l-42.7,46.2l-14.3-16.4
                                            ...
                                            <polyline className="path" fill="none" stroke="#0acf97" strokeWidth="6" strokeLinecap="round" strokeMiterlimit="10" points="113,52.8
